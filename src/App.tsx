  ...
  return (
    <div className="w-full bg-black text-white font-body selection:bg-white selection:text-black min-h-screen relative">
      ...
      <nav className="fixed top-6 left-0 right-0 z-50 flex items-center justify-between px-8 lg:px-24">
        <div className="liquid-glass h-12 w-12 rounded-full flex items-center justify-center btn-hover cursor-pointer">
          <span className="font-heading italic text-2xl mt-1">a</span>
        </div>
        ...
        <div className="hidden md:flex liquid-glass rounded-full p-2 items-center gap-2">
          ...
          <a href={SITE.githubLink} target="_blank" rel="noopener noreferrer" className="btn-hover bg-white text-black rounded-full px-5 py-2.5 flex items-center gap-1.5 text-[13px] font-semibold font-body ml-2">
      ...
      <section className="h-screen overflow-hidden bg-black relative flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center justify-center pt-32 px-4 text-center">
          ...
          >
            Building complete systems where electronics meet intelligence. From bare-metal firmware to modern web infrastructure, engineering the physical and digital.
          </motion.p>
          ...
          >
            ...
            <a href={SITE.githubLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[13px] uppercase tracking-widest font-medium text-white/75 nav-link">
      ...
      <section id="github" className="min-h-[80vh] relative flex flex-col items-center justify-center pt-32 pb-20 px-8 md:px-16 lg:px-24 text-center">
        <div className="relative z-10 flex flex-col items-center max-w-3xl mx-auto">
          ...
          <a href={SITE.githubLink} target="_blank" rel="noopener noreferrer" className="liquid-glass-strong btn-hover rounded-full px-8 py-4 flex items-center gap-3 text-[14px] uppercase tracking-widest font-medium">
      ...
      <section id="contact" className="relative flex flex-col pt-32 pb-32 px-8 md:px-16 lg:px-24 max-w-[1400px] mx-auto w-full border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <a href={SITE.githubLink} target="_blank" rel="noopener noreferrer" className="liquid-glass card-hover rounded-[1.5rem] p-8 flex flex-col gap-6 group">
          ...
          <a href={SITE.linkedin} target="_blank" rel="noopener noreferrer" className="liquid-glass card-hover rounded-[1.5rem] p-8 flex flex-col gap-6 group">
            <div className="bg-white/10 w-12 h-12 rounded-full flex items-center justify-center group-hover:bg-white/20 transition-colors">
          ...
          <a href={SITE.email} className="liquid-glass card-hover rounded-[1.5rem] p-8 flex flex-col gap-6 group">
            <div className="bg-white/10 w-12 h-12 rounded-full flex items-center justify-center group-hover:bg-white/20 transition-colors">
          ...
          <a href={SITE.resume} target="_blank" rel="noopener noreferrer" className="liquid-glass card-hover rounded-[1.5rem] p-8 flex flex-col gap-6 group">
            <div className="bg-white/10 w-12 h-12 rounded-full flex items-center justify-center group-hover:bg-white/20 transition-colors">
